...
class ShadyPoint: CustomStringConvertible {
    ...
    static func createPoler(rho: Double, theta: Double) -> Point {
        return Point(rho: rho, theta: theta)
    }
    ...
    class ShadyPointFactory {
        ...
        static func createPoler(rho: Double, theta: Double) -> ShadyPoint {
...
//    print(p4)
    ...
    let p5 = ShadyPoint.ShadyPointFactory.createPoler(rho: 1, theta: Double.pi)
    print(p5)
    ...
    // but the factory itself is usable, maby you don't want this
}
